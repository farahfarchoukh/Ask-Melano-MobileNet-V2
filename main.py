...
def count_images(directory):
    ...
    return sum(1 for file in Path(directory).rglob('*') if file.suffix.lower() in extensions)

# Count images in train, data, and test folders
...
print(f"Number of images in Data folder: {data_count}")
